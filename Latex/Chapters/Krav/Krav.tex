...
\begin{itemize}
\item Brugeren trykker på "ADD DEVICE".
...
\begin{itemize}
	\item Brugeren trykker på "REMOVE DEVICE".
	\item Systemet præsenterer listen over de godkendte enheder
	\item Brugeren kan vælge imellem de godkendte bluetooth-enheder, som skal fjernes fra listen.
\end{itemize} 

\subsubsection{UC 3 - LOCK ON / LOCK OFF / AUTO}

\begin{itemize}
	\item I tvivl om staten her
\end{itemize}
